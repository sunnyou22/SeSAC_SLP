...
class SecondSearchCollecitionViewCell: BaseCollectionViewCell {
...
class TopSearchCollecitionViewCell: UICollectionViewCell {
...
//    func configrue() {
//        [label].forEach { customView.addSubview($0) }
//        contentView.addSubview(customView)
//    }
//
//    func setConstraints() {
